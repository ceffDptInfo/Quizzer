    ...
    <div class="container-fluid mt-5">
      <div class="row">
        ...
        <div class="offset-1 col-3">
          ...
          <div class="mt-5 gray">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?= $_SERVER['SERVER_ADDR']."/player/joining.php?code=".$_SESSION['code'] ?>" alt="Qr code pour rejoindre la partie" class="w-100 p-4 object-fit-fill">
          </div>
          <form method="post">
